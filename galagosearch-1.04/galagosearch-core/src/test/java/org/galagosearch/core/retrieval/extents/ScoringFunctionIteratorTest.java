...
public class ScoringFunctionIteratorTest extends TestCase {
    ...
    public static class FakeScoreIterator extends ScoringFunctionIterator {
        ...
        public double scoreCount(int count, int length){//String kunal,int docCount,int doc) {
            return count + length;
        }
        public double scoreCount1(int count, int length,String kunal,int docCount,int doc) {
            return count + length;
        }
    }
