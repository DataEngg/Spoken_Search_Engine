...
public class BatchSearch {
    ...
    public static void run(String[] args, PrintStream out) throws Exception {
        ...
        System.out.println("Choose Quality Predictor that you want to use for spoken query ");
		System.out.println("1)Average IDF ");
		System.out.println("2) Quality Scope ");
		System.out.println("Choose the number from above ");
		Scanner s1=new Scanner(System.in);
		 String s=s1.next();
		System.out.println("Choose Scoring Model that you want to use for spoken query ");
		System.out.println("1)Dirichlet ");
		System.out.println("2)Vector Space ");
		System.out.println("Choose the number from above ");
		Scanner s2=new Scanner(System.in);
		 String s3=s2.next();
		 SearchWebHandler.value=s;
		 SearchWebHandler.value1=s3;
